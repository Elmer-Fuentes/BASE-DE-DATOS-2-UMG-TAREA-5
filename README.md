...
Para SQL Server:
Conectarse a una instancia mediante SSMS.

Crear la base de datos BASE_DATOS_2_T5.

Ejecutar el script SQL para generar tablas y objetos programables.

Para Oracle:
Utilizar Oracle SQL Developer o SQL*Plus.

Ejecutar los scripts de creación de tablas.

Compilar los paquetes o triggers PL/SQL proporcionados en el archivo.
